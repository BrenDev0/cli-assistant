...
class SkillBuilderAssistant:
    ...
    .my_assistant/skills/<name>/ folder."""
    ...
    async def build(self, skill_name: str, description: str) -> str:
        ...
        try:
            ...
            return (
                ...
                f".my_assistant/skills/{skill_name}/ — retry with the same "
            ...
            return (
                ...
                f".my_assistant/skills/{skill_name}/ for partial output."
            )

        return f"Skill '{skill_name}' created/updated at .my_assistant/skills/{skill_name}/.\n{summary}"
